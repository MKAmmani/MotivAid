...
const checkTypeOfPregnancy = () => {
    return (
        form.type_of_pregenency !== "single" && form.type_of_pregenency !== ""
    ); // Only single pregnancy is not high risk
};
...
const updateWarningBadge = () => {
    ...
    const isHighRiskAge =
        !isNaN(parseInt(form.age)) &&
        (parseInt(form.age) < 18 || parseInt(form.age) > 35);
    ...
    if (
        ...
        hasPreviousPPH ||
        hasCaesareanSection ||
        hasAbnormalGestationalAge ||
        hasHighGravidaParity ||
        hasHighRiskPregnancyType
    ) {
...
const isFormValid = computed(() => {
    ...
    if (!form.history_of_antenatal_visit) {
        errors.history_of_antenatal_visit =
            "History of antenatal visit is required";
    ...
    if (!form.gravida.trim()) {
        ...
        if (!gravidaPattern.test(form.gravida)) {
            errors.gravida =
                "Gravida/Parity must be in format: number/number (e.g., 2/1)";
        }
    }
    ...
    if (!form.history_Of_ceaserian_section) {
        errors.history_Of_ceaserian_section =
            "History of Caesarean section is required";
    ...
    if (!form.type_of_pregenency) {
        ...
        !["single", "twin", "triplet", "higher"].includes(
            form.type_of_pregenency
        )
    ) {
    ...
    if (!form.gestational_age.trim()) {
        ...
        if (isNaN(gestationalAgeNum) || gestationalAgeNum <= 0) {
            errors.gestational_age =
                "Gestational age must be a positive number";
        }
    }
                    ...
                    <form @submit.prevent="addPatient" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-1"
                                    >History Of Antenatal visit</label
                                >
                                <select
                                ...
                                <div
                                    v-if="
                                        form.errors.history_of_antenatal_visit
                                    "
                                    class="text-red-500 text-sm mt-1"
                                >
                                    {{ form.errors.history_of_antenatal_visit }}
                                ...
                                <div
                                    v-if="
                                        form.history_of_antenatal_visit === 'no'
                                    "
                                    class="bg-yellow-50 border-l-4 border-yellow-400 p-2 mt-1 text-xs text-yellow-700 flex items-center"
                                >
                                    <svg
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    :class="{
                                        'border-red-500':
                                            form.errors.history_of_previous_pph,
                                        'border-gray-300':
                                            !form.errors
                                                .history_of_previous_pph,
                                    }"
                                ...
                                <div
                                    v-if="form.errors.history_of_previous_pph"
                                    class="text-red-500 text-sm mt-1"
                                >
                                    {{ form.errors.history_of_previous_pph }}
                                </div>
                                ...
                                <div
                                    v-if="
                                        form.history_of_previous_pph === 'yes'
                                    "
                                    class="bg-yellow-50 border-l-4 border-yellow-400 p-2 mt-1 text-xs text-yellow-700 flex items-center"
                                >
                                    <svg
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-1"
                                    >History Of Ceaserian Section</label
                                >
                                <select
                                ...
                                <div
                                    v-if="
                                        form.errors.history_Of_ceaserian_section
                                    "
                                    class="text-red-500 text-sm mt-1"
                                >
                                    {{
                                ...
                                <div
                                    v-if="
                                        form.history_Of_ceaserian_section ===
                                        'yes'
                                    "
                                    class="bg-yellow-50 border-l-4 border-yellow-400 p-2 mt-1 text-xs text-yellow-700 flex items-center"
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    :class="{
                                        'border-red-500':
                                            form.errors.type_of_pregenency,
                                        'border-gray-300':
                                            !form.errors.type_of_pregenency,
                                    }"
                                    class="w-full px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-motivaid-teal"
                                ...
                                <div
                                    v-if="form.errors.type_of_pregenency"
                                    class="text-red-500 text-sm mt-1"
                                >
                                    {{ form.errors.type_of_pregenency }}
                                </div>
                                ...
                                <div
                                    v-if="
                                        form.type_of_pregenency !== 'single' &&
                                        form.type_of_pregenency !== ''
                                    "
                                    class="bg-yellow-50 border-l-4 border-yellow-400 p-2 mt-1 text-xs text-yellow-700 flex items-center"
                                >
                        ...
                        <div>
                            ...
                            />
                            <div
                                v-if="form.errors.gestational_age"
                                class="text-red-500 text-sm mt-1"
                            >
                                {{ form.errors.gestational_age }}
                            </div>
